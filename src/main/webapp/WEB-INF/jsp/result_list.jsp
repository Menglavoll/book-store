								...
								<div class="pagination">
									<ul>
										<li class="disablepage">
											<a href="${pageContext.request.contextPath}/book/searchbooksbyname?name=${name}&currentPage=${pagebooks.currentPage==1?1:pagebooks.currentPage-1}">
												&lt;&lt;上一页
											</a>
										</li>
										<li>
										...
										<li class="nextPage">
											<a href="${pageContext.request.contextPath}/book/searchbooksbyname?name=${name}&currentPage=${pagebooks.currentPage==pagebooks.totalPage?pagebooks.totalPage:pagebooks.currentPage+1}">
												下一页>>
											</a>
										</li>
									</ul>
