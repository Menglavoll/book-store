								...
								<form action="/user/updateuser" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										<tr>
											...
											<td style="width:40%; padding-left:20px"><p>${u.email}</p></td>
											<td>&nbsp;</td>


										</tr>
										<tr>
											<td style="text-align:right">修改用户名：</td>
											<td><input type="text" name="username"
													   value="${u.userName}" class="textinput" /></td>
											<td style="padding-left:20px">用户名至少6位</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
