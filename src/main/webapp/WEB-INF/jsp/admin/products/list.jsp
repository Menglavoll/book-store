...
<body onload="setProductCategory('${condition.category}')">
	<br>
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/book/findbookbycondition"
		method="post">
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
								...
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									价格区间(元)：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="minprice" size="10" value="${condition.minPrice == 0 ? min : condition.minPrice}" />- <input type="text"
									name="maxprice" size="10" value="${condition.maxPrice == 0 ? max : condition.maxPrice}" /></td>
							</tr>
							...
							<c:forEach items="${books}" var="book">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="/book/update?bookid=${book.bookId}">
											<img
