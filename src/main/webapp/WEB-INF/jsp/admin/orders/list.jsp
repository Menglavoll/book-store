			...
			<TBODY>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									收件人：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="receiverName" size="15" value="" id="Form_userName"
									class="bg" /></td>
							</tr>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						...
						<c:forEach items="${adminorders}" var="order">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="20%">${order.orderPackage}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${order.receiver}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${order.address}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${order.recMobile}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center">
									${order.total}</td>
								<td width="8%" align="center">${order.userId}</td>
								<td width="10%" align="center">${order.state == 0 ? "未支付" : "已支付"}</td>
